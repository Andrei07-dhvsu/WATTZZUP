                        ...
                        <section class="profile-form">
                            ...
                            <div class="profile">
                                <div class="profile-img">
                                    ...
                                    <button class="btn-primary change" onclick="tenant_profie()"><i class='bx bxs-user'></i> Tenant Profile</button>
                                    <button class="btn-primary change" onclick="submeter()"><i class='bx bxs-tachometer'></i> Electric Meter</button>
                                    <?php if ($rooms_user_id): ?>
                                        <button class="btn-primary change" data-bs-toggle="modal" data-bs-target="#addSubTenant"><i class='bx bx-user-plus'></i> Sub Tenant</button>
                                    <?php endif; ?>
                                ...
                                <?php else: ?>
                                    <div id="tenant_profile" class="no_tenant">
                                        ...
                                        <div class="addBtn2">
                                            <button type="submit" class="btn-primary" data-bs-toggle="modal" data-bs-target="#tenantModal"><i class='bx bx-user-plus'></i> Add Tenant</button>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if ($submeter_id): ?>
                                    <div id="submeter" style="display: none;">
                                        <form action="controller/room-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                            ...
                                            <div class="addBtn">
                                                <button type="submit" class="btn-primary" name="btn-add-submeterId" id="btn-update" onclick="return IsEmpty(); sexEmpty();">Update</button>
                                            </div>
                                        </form>
                                    </div>
                                <?php else: ?>
                                    <div id="submeter" class="no_submeter" style="display: none;">
                                        ...
                                        <div class="addBtn2">
                                            <button type="submit" class="btn-primary" data-bs-toggle="modal" data-bs-target="#submeterModal"><i class='bx bx-user-plus'></i> Add Submeter</button>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
                                ...
                                <section class="data-form-modals">
                                    <div class="registration">
                                        <form action="controller/room-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                            ...
                                            <div class="addBtn">
                                                <button type="submit" class="btn-primary" name="btn-add-tenant" id="btn-add" onclick="return IsEmpty(); sexEmpty();">Add</button>
                                            </div>
                                        </form>
                                    </div>
                                </section>
                                ...
                                <section class="data-form-modals">
                                    <div class="registration">
                                        <form action="controller/room-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                            ...
                                            <div class="addBtn">
                                                <button type="submit" class="btn-primary" name="btn-add-submeterId" id="btn-add" onclick="return IsEmpty(); sexEmpty();">Add</button>
                                            </div>
                                        </form>
                                    </div>
                                </section>
                                ...
                                <section class="data-form-modals">
                                    <div class="registration">
                                        <form action="controller/room-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
                                            ...
                                            <div class="addBtn">
                                                <button type="submit" class="btn-primary" name="btn-add-tenant" id="btn-add" onclick="return IsEmpty(); sexEmpty();">Add Subtenant</button>
                                            </div>
                                        </form>
                                    </div>
                                </section>
