							...
							<div class="registration">
								<form action="controller/system-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
									<div class="row gx-5 needs-validation">
										...
										<label class="form-label" style="text-align: left; padding-top: .5rem; padding-bottom: 2rem; font-size: 1rem; font-weight: bold;"><i class='bx bxs-key'></i> Access Token <p>Last update: <?php echo $accessKeyLastUpdate  ?></p></label>

										<div class="col-md-12">
											<label for="access_key" class="form-label">Add Access Token<span> *</span></label>
											<input type="text" class="form-control" autocapitalize="on" autocomplete="off" name="access_key" id="access_key" required value="<?php echo $access_key ?>">
											<div class="invalid-feedback">
												Please provide a Generate Access Token.
											</div>
										</div>
							...
							<div class="registration">
								<form action="controller/system-controller.php" method="POST" class="row gx-5 needs-validation" name="form" onsubmit="return validate()" novalidate style="overflow: hidden;">
									<div class="row gx-5 needs-validation">
										...
										<label class="form-label" style="text-align: left; padding-top: .5rem; padding-bottom: 2rem; font-size: 1rem; font-weight: bold;"><i class='bx bxs-dollar-circle' ></i> Electricity Rate <p>Last update: <?php echo $kwhCostLastUpdate ?></p></label>

										<div class="col-md-12">
											<label for="kwh_cost" class="form-label">Electricity Rate (₱/kWh)<span> *</span></label>
											<input type="number" class="form-control" autocapitalize="on" autocomplete="off" name="kwh_cost" id="kwh_cost" required value="<?php echo $kwh_cost ?>">
											<div class="invalid-feedback">
												Please provide a Electricity Rate (₱/kWh).
											</div>
										</div>
